...
const sections: Section[] = [
  ...
  },
  {
    ...
    rows: [
      ...
      { cell1: '/tools', cell2: 'List available tools', code: true },
      { cell1: '/stats', cell2: 'Latency stats (last day)', code: true },
      { cell1: '/skills', cell2: 'Agent skill profile (success rates)', code: true },
      { cell1: '/mcp', cell2: 'MCP readiness snapshot', code: true },
  ...
  },
  {
    ...
    rows: [
      ...
      { cell1: 'GET /agent/tools/health', cell2: 'Tool + MCP readiness', code: true },
      { cell1: 'GET /agent/models', cell2: 'List models and routing', code: true },
      { cell1: 'GET /agent/stats', cell2: 'Latency percentiles by endpoint', code: true },
      { cell1: 'GET /analytics/skills', cell2: 'Agent skill profile', code: true },
