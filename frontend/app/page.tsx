...
const navCards = [
  ...
  { href: '/history',   title: 'History',              description: 'Browse past executions and their results.',      icon: 'LOGS' },
    ...
    <div className="space-y-8">
      ...
      <div className="panel panel-soft fade-up p-6 md:p-7 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <h1 className="section-title text-3xl md:text-4xl font-bold mb-2">Dashboard</h1>
          <p className="text-muted max-w-xl">Telemetry, budget, and execution history in one live operations deck.</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 fade-up-delay">
        ...
        <div className="panel p-5 flex items-center gap-4">
          <span className={`w-3 h-3 rounded-full shrink-0 ${loading ? 'bg-gray-500' : stats.agentReady ? 'bg-[color:var(--success)]' : 'bg-[color:var(--danger)]'}`} />
          <div>
